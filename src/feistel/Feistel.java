...
public class Feistel {
    ...
    public String textoplano(String texto, String clave, boolean cifrado) {
        ...
        for (int i = 0; i < bloques.size(); i++) {
            ...
            if (cifrado) {
                nuevoArreglo.addAll(cifrar(Izquierda, Derecha, claves, 8, cifrado));
            } else {
                nuevoArreglo.addAll(cifrar(Derecha, Izquierda, claves, 8, cifrado));
            }
            Izquierda.clear();
            Derecha.clear();
    ...
    public ArrayList<Integer> cifrar(ArrayList<Integer> Izquierda, ArrayList<Integer> Derecha, ArrayList<Integer> clave, int iteraciones, boolean cifra) {
        ...
        for (int i = 0; i < iteraciones; i++) {
            ...
            System.out.println("CLAVE FINAL " + i + " " + clave);
            System.out.println("DERECHA chars inicio: " );
            imprimirParte(Derecha);
            System.out.println("IZquierda chars inicio: " );
            imprimirParte(Izquierda);
            ...
            System.out.println("DERECHA chars: " );
            imprimirParte(Derecha);
            System.out.println("IZquierda chars: " );
            imprimirParte(Izquierda);
            System.out.println("Clave Cifrada: " + cadena);
            System.out.println("==================================");
        }
